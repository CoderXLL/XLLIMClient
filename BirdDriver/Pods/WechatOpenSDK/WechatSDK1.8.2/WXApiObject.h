...
@property (strong, nonnull) NSString* openID;
...
/** 错误提示字符串 */
@property (strong, nonnull) NSString *errStr;
/** 响应类型 */
@property (nonatomic, assign) int type;
...
/** 商家向财付通申请的商家id */
@property (strong, nonnull) NSString *partnerId;
/** 预支付订单 */
@property (strong, nonnull) NSString *prepayId;
/** 随机串，防重发 */
@property (strong, nonnull) NSString *nonceStr;
/** 时间戳，防重发 */
@property (nonatomic, assign) UInt32 timeStamp;
/** 商家根据财付通文档填写的数据和签名 */
@property (strong, nonnull) NSString *package;
/** 商家根据微信开放平台文档对数据做的签名 */
@property (strong, nonnull) NSString *sign;
...
/** 财付通返回给商家的信息 */
@property (strong, nonnull) NSString *returnKey;
 ...
 */
@property (strong, nonnull) NSString* scope;
/** 第三方程序本身用来标识其请求的唯一性，最后跳转回第三方程序时，由微信终端回传。
 * @note state字符串长度不能超过1K
 */
@property (strong, nonnull) NSString* state;
@end
...
@property (strong, nonnull) NSString* code;
/** 第三方程序发送时用来标识其请求的唯一性的标志，由第三方程序调用sendReq时传入，由微信终端回传
 * @note state字符串长度不能超过1K
 */
@property (strong, nonnull) NSString* state;
@property (strong, nonnull) NSString* lang;
@property (strong, nonnull) NSString* country;
@end
 ...
 * @see WXMediaMessage
 */
@property (strong, nonnull) WXMediaMessage* message;
 ...
 * @attention 长度不能超过32位
 */
@property (strong, nonnull) NSString*  sessionFrom;
@end
 ...
 */
@property (strong, nonnull) NSString* extMsg;
/**
 * 跳转的公众号类型
 ...
 * @attention 长度不能超过512字节
 */
@property(strong, nonnull) NSString* tousrname;
/** 如果用户加了该公众号为好友，extMsg会上传到服务器
 * @attention 长度不能超过1024字节
 */
@property(strong, nonnull) NSString* extMsg;
 ...
 * @note 长度不能超过1K
 */
@property (strong, nonnull) NSString *description;
/** 缩略图数据
 * @note 大小不能超过32K
 */
@property (strong, nonnull) NSData   *thumbData;
/**
 * @note 长度不能超过64字节
 */
@property (strong, nonnull) NSString *mediaTagName;
/**
 *
 */
@property (strong, nonnull) NSString *messageExt;
@property (strong, nonnull) NSString *messageAction;
/**
 * 多媒体数据对象，可以为WXImageObject，WXMusicObject，WXVideoObject，WXWebpageObject等。
 */
@property (strong, nonnull) id        mediaObject;
 ...
 * @note 大小不能超过10M
 */
@property (strong, nonnull) NSData    *imageData;
 ...
 * @note 长度不能超过10K
 */
@property (strong, nonnull) NSString *musicUrl;
/** 音乐lowband网页的url地址
 * @note 长度不能超过10K
 */
@property (strong, nonnull) NSString *musicLowBandUrl;
/** 音乐数据url地址
 * @note 长度不能超过10K
 */
@property (strong, nonnull) NSString *musicDataUrl;

/**音乐lowband数据url地址
 * @note 长度不能超过10K
 */
@property (strong, nonnull) NSString *musicLowBandDataUrl;
 ...
 * @note 长度不能超过10K
 */
@property (strong, nonnull) NSString *videoUrl;
/** 视频lowband网页的url地址
 * @note 长度不能超过10K
 */
@property (strong, nonnull) NSString *videoLowBandUrl;
 ...
 * @note 不能为空且长度不能超过10K
 */
@property (strong, nonnull) NSString *webpageUrl;
 ...
 * @note 长度不能超过2K
 */
@property (strong, nonnull) NSString *extInfo;
/** App文件数据，该数据发送给微信好友，微信好友需要点击后下载数据，微信终端会回传给第三方程序处理
 * @note 大小不能超过10M
 */
@property (strong, nonnull) NSData   *fileData;
 ...
 * @note 大小不能超过10M
 */
@property (strong, nonnull) NSData    *emoticonData;
 ...
 * @note 长度不超过64字节
 */
@property (strong, nonnull) NSString  *fileExtension;
 ...
 * @note 文本内容
 */
@property (strong, nonnull) NSString *contentText;
